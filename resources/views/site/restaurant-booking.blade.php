...
{{--                        <a href="{{route('site.restaurants.view', $restaurant)}}" class="btn btn-restaurant">View Menu</a>--}}
{{--                    </div>--}}
...
<div id="page-content" class=" flex flex-grow flex-col max-w-12xl w-[80%] mx-auto py-[80px]" style="background-image:url('{{$restaurant->getFirstMediaUrl('restaurant_bgs')}}'); background-size: cover">

    <div class="flex">
        <div id="restaurant-details"
             class="flex flex-col items-center ml-5 w-1/4 rounded-[64px] border-2 bg-white">
            <h2 class="text-[41px] tracking-[14px] mt-16 uppercase text-center">{{$restaurant->name}}</h2>
            ...
            <div class="flex flex-grow w-full px-12 mt-12">
