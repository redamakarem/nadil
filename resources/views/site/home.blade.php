    ...
    <div id="main-content" class="h-full">
        <div class="flex flex-col px-24 py-[80px]">
            ...
            <div class="relative carousel-container flex rtl:flex-row-reverse items-center">
                <div class="absolute bg-blue-100 carousel-nav p-4 prev rounded-full z-10 -left-4 top-[30%] w-12 h-12 flex justify-center items-center shadow-md"><i class="fa-solid fa-chevron-left"></i></div>
                ...
                <div class="absolute bg-blue-100 carousel-nav p-4 next rounded-full z-10 -right-4 top-[30%] w-12 h-12 flex justify-center items-center shadow-md"><i class="fa-solid fa-chevron-right"></i></div>
            </div>
