    ...
    <div id="main-content" class="h-full">
        <div class="flex flex-col px-24 py-[80px]">
            ...
            <div>
                <form action="#" class="mb-6">
                    <div class="flex my-4 items-center">
                        <input class="font-lato flex text-center border-none border-r-gray-700/50 py-6 uppercase bg-nadilBtn-100 outline-none rounded-l-lg" 
            ...
            <div class="relative carousel-container flex rtl:flex-row-reverse items-center">
                ...
                <div class="absolute bg-nadilBtn-100 carousel-nav p-4 next rounded-full z-10 -right-4 top-[30%] w-12 h-12 flex justify-center items-center shadow-md"><i class="fa-solid fa-chevron-right"></i></div>
            </div>
