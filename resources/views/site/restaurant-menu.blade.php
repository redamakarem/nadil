        ...
        <div class="flex">
            <div id="restaurant-details"
                ...
                <div class="flex w-full px-4 mt-6 space-x-8 justify-center">
                        <a href="#" class="uppercase px-8 py-4 bg-nadilBtn-100 tracking-[6px] rounded-[19px]">{{__('nadil.general.phone')}}</a>
                        <a href="#" class="uppercase px-8 py-4 bg-nadilBtn-100 tracking-[6px] rounded-[19px]">{{__('nadil.general.email')}}</a>
                </div>
                <div class="flex w-full px-4 mt-6 space-x-8 justify-center">
